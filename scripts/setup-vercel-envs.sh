...
echo "   - NEXT_PUBLIC_APP_URL                (https://sentinel.supersonics.cl for production, https://sentinel-fleet-staging.vercel.app for staging, https://sentinel-fleet-dev.vercel.app for dev)"
echo ""
